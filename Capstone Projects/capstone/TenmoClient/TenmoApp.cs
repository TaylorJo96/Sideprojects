...
namespace TenmoClient
{
    public class TenmoApp
    {
        ...
        private void ViewAllTransfers()
        {
            ...
            int transferSelection = console.PromptForInteger("Please enter the ID of the transfer you would like to view", 3001, int.MaxValue);
            ...
            while (pendingChoice != 0)
            {
                ...
                while (approveDeny != 0)
                {
                    if (approveDeny == 1)
                    {
                        ...
                        console.PrintSuccess("Transfer Successfully Approved.");
                        console.Pause();
                        break;
                    }
                    else if (approveDeny == 2)
                    {
                        ...
                        console.PrintSuccess("Transfer Succesfully Denied");
                        console.Pause();
                        break;
                    }
                }
        ...
        private void SendTransfer()
        {
           ...
           console.PrintSuccess("Transfer Successful!");
            ...
            else if (successful != true)
            {
                ...
                console.PrintError("Transfer unsuccessful.");
        ...
        private void RequestTransfer()
        {
            ...
            if (successful == true)
            {
                console.PrintSuccess("Transfer Request Successful!");
            ...
            else if (successful != true)
            {
             ...
             console.PrintError("Transfer Request Unsuccessful.");
